<p align="center">
  <img src="web/public/logo.svg?v=0.6.1-white" width="108" alt="VOZEB logo">
</p>
...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-v0.6.1-2563eb?style=flat-square" alt="Version"></a>
...
VOZEB 当前版本为 `v0.6.1`，这是基于原开源项目 [basketikun/infinite-canvas](https://github.com/basketikun/infinite-canvas) 继续开发的二开版本。感谢原创作者 basketikun 对无限画布、AI 创作工作流、Canvas Agent 和 Codex 插件能力的开源贡献。
...
打开 `http://服务器IP:3000`，第一次注册的账号会自动成为管理员。管理员登录后可进入 `管理员后台`，配置网站标题、Logo、SEO、注册策略、邮箱服务、模型渠道、默认模型、用户额度和公共提示词库。
...
VOZEB 增加了账号系统和后台管理能力。管理员可以控制注册是否开放、是否要求邮箱注册，调整用户角色、账号状态、每日额度、签到奖励、系统接口渠道和默认模型。后台采用侧边栏切换布局，概览、系统设置、用户管理和公共提示词库分区更清楚。
