---
title: Codex App 插件
description: 在 Codex App 中安装并使用 VOZEB 插件
---

# Codex App 插件

VOZEB 提供了一个 Codex App 插件，用来把 Codex 和本地 Canvas Agent 连接起来。安装后，你可以直接在 Codex 中说“打开 VOZEB”，让 Codex 打开画布、读取节点、创建节点并触发生成流程。
...
如果你正在 VOZEB 仓库中开发插件，可以直接使用仓库自带的 marketplace：
